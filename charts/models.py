...
class SubProduct(models.Model):
    ...
    date=models.DateField(null=True, blank=True)
    description=models.TextField()
    price=models.ForeignKey(Input, on_delete=models.CASCADE)
...
class Product(models.Model):
    ...
    date=models.DateField(null=True, blank=True)
    description=models.TextField()
    price=models.ForeignKey(SubProduct, on_delete=models.CASCADE)
...
class Purchase(models.Model):
    invoice=models.ForeignKey(Product, on_delete=models.CASCADE)
    seller=models.ForeignKey(Provider, on_delete=models.CASCADE)
    date=models.DateField(null=True, blank=True)
    description=models.TextField()
